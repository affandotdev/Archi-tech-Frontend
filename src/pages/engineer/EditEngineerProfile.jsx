        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-4xl mx-auto py-8 px-4">
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <Button variant="outline" onClick={() => navigate("/engineer/profile")}>Back</Button>
                </div>
                ...
                <Card title="Technical Details">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <Input label="Discipline" name="discipline" value={profile.discipline} onChange={handleChange} placeholder="e.g. Structural, MEP" />
                    ...
                    <div className="mb-6">
                        <label className="block mb-2 text-sm font-medium text-slate-700">Bio / Expertise</label>
                        <textarea
                            name="bio"
                            value={profile.bio}
