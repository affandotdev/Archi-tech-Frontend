        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <Button variant="outline" onClick={() => navigate("/architect/profile")}>
                        Back
                    </Button>
                </div>
                                    ...
                                    <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                                        {currentAvatar ? (
                                            ...
                                            <span className="text-4xl font-semibold text-slate-300">
                                                {profile.first_name ? profile.first_name.charAt(0).toUpperCase() : "A"}
                                            </span>
                                        )}
                                    </div>
                                </div>
                        ...
                        <Card title="Professional Details">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                <Input
                                    ...
                                    onChange={handleChange}
                                    placeholder="e.g. Skyline Architects"
                                />
                                <Input
